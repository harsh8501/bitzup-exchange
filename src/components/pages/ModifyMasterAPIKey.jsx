            ...
            <div className="col-lg-9 col-md-12 api-content" ref={contentRef}>
                ...
                <div className="api-table-box"><table className="table table-striped api-table mb-0">
                    ...
                    <tbody>
                        ...
                        <tr><td style={{ paddingLeft: "28px" }}>&gt; Wallet</td><td>false</td><td>array</td><td><span className="pill">"AccountTransfer"</span>, <span className="pill">"SubMemberTransfer"</span>, <span className="pill">"SubMemberTransferList"</span>, <span className="pill">"Withdraw"</span></td></tr>
