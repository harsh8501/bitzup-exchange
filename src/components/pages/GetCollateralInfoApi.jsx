...
export const GetCollateralInfoApi = () => {
    ...
    <div className="api-doc-container">
      ...
      <div className="docs-panel" ref={contentRef}>
        <div className="breadcrumb">
          <span>Account</span> <IoIosArrowForward size={12} /> <span className="pill">Get Collateral Info</span>
        </div>
        <h1 className="api-title">Get Collateral Info</h1>
        <p style={{ color: "#888", marginBottom: "40px" }}>Query detailed information about your collateral assets.</p>
        ...
        <div className="api-box">
          ...
          <div className="tree-view">
            {[
              { name: "currency", type: "string", desc: "Collateral asset (e.g., USDT, BTC, ETH)" },
            ].map(p => (
              <div className="tree-item" key={p.name}>
                <span className="p-name">{p.name}</span>
                <span className="p-type">{p.type}</span>
