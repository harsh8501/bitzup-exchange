    ...
    <div className="api-doc-container">
      ...
      <div className="docs-panel" ref={contentRef}>
        <div className="breadcrumb">
          <span>User</span> <IoIosArrowForward size={12} /> <span className="pill">Get API Key Information</span>
        </div>
        <h1 className="api-title">Get API Key Information</h1>
        <p style={{ color: "#888", marginBottom: "40px" }}>Query the permissions and configuration details associated with your API key.</p>
