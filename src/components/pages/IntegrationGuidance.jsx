    ...
    <div className="container-fluid p-0">
      <div className="api-layout">
        ...
        <p className="api-desc mb-4">
          IP addresses located in the US or Mainland China are restricted and will return a <code>403 Forbidden</code> error for requests to Bitzup API.
        </p>
        ...
        <ul className="mb-3 text-white">
          <li>Testnet: <code>https://api.bitzup.com</code></li>
          <li>Mainnet (both endpoints are available):
            <ul>
              <li><code>https://api.bitzup.com</code></li>
              <li><code>https://api.bitzup.com</code></li>
            </ul>
          </li>
        </ul>
        ...
        <p className="api-desc mb-3">
          <strong>System-generated API Keys:</strong> The API key generated by the Bitzup system operates with HMAC encryption. You will be provided with a pair of public and private keys. Please treat this pair of keys as passwords and keep them safe.
        </p>
        <p className="api-desc mb-3">
          Follow <a href="https://github.com/bitzup-exchange/api-usage-examples" target="_blank" rel="noreferrer">HMAC sample scripts</a> to complete encryption procedures.
        </p>

        <p className="api-desc mb-3">
          <strong>Auto-generated API Keys:</strong> Self-generated API keys operate with RSA encryption. You must create your public and private keys through the software, and then only provide the public key to Bitzup, we will never hold your private key.
        </p>
        <ol className="mb-4 text-white">
          <li>Use <a href="https://github.com/bitzup-exchange/api-rsa-generator" target="_blank" rel="noreferrer">api-rsa-generator</a> to create RSA private and public keys</li>
          <li>Follow the <a href="https://github.com/bitzup-exchange/api-usage-examples" target="_blank" rel="noreferrer">RSA sample scripts</a> to complete encryption procedures.</li>
        </ol>
