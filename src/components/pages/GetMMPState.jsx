...
export const GetMMPState = () => {
  ...
  "time": 1675843188984
    ...
    const codeMap = {
        HTTP: `GET /v5/account/mmp-state?baseCoin=ETH HTTP/1.1
Host: test.bitzup.com
Authorization: Bearer <YOUR_API_KEY>`,

    Python: `import requests

url = "https://test.bitzup.com/v5/account/mmp-state?baseCoin=ETH"
headers = {
    "Authorization": "Bearer <YOUR_API_KEY>"
}
...
public class GetMMPStateDemo {
    public static void main(String[] args) throws Exception {
        String url = "https://test.bitzup.com/v5/account/mmp-state?baseCoin=ETH";
...
async function getMmpState() {
    try {
        const response = await axios.get(
            'https://test.bitzup.com/v5/account/mmp-state',
            {
                params: {
                    baseCoin: 'ETH'
                },
          ...
          <div className="row">
            ...
            <div className="col-lg-9 col-md-8 api-content" ref={contentRef}>
              ...
              <div className="breadcrumb mb-4">
                ...
                <span className="pill">Get MMP State</span>
              </div>

              {/* Title */}
              <h1 className="api-title">Get MMP State</h1>
              ...
              <div className="http-path">
                ...
                <span className="path">/v5/account/mmp-state</span>
              </div>
                ...
                <table className="table table-striped api-table mb-0">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>&gt; mmpEnabled</td>
                      <td>boolean</td>
                      <td>Whether the account is enabled with MMP</td>
                    </tr>
                    <tr>
                      <td>&gt; window</td>
                      <td>string</td>
                    ...
                    <tr>
                      <td>&gt; qtyLimit</td>
                      <td>string</td>
                      <td>Trade qty limit (Positive number, up to 4 decimal places)</td>
                    </tr>
                    <tr>
                      <td>&gt; deltaLimit</td>
                      <td>string</td>
                      <td>Delta limit (Positive number, up to 4 decimal places)</td>
                    </tr>
                    <tr>
                      <td>&gt; mmpFrozenUntil</td>
                      <td>string</td>
                      <td>Unfreeze time (ms)</td>
                    </tr>
                    <tr>
                      <td>&gt; mmpFrozen</td>
                      <td>boolean</td>
