...
export const GetFundCustodialSubAcct = () => {
...
print(session.get_fund_custodial_sub_acct(
    pageSize="2",
))`,
    };
    ...
    return (
        <div className="container-fluid p-0"><div className="api-layout"><div className="row">
            <div className="col-lg-9 col-md-12 api-content" ref={contentRef}>
                <div className="breadcrumb mb-4"><span className="kline-market">User</span><span className="mx-2"><IoIosArrowForward className="kline-arrow" /></span><span className="pill">Get Fund Custodial Sub Acct</span></div>
                <h1 className="api-title">Get Fund Custodial Sub Acct</h1>
                <p className="api-desc">The institutional client can query the fund custodial sub accounts.</p>
                ...
                <div className="http-path"><span className="method get">GET</span><span className="path">/v5/user/escrow_sub_members</span></div>
                ...
                <div className="api-table-box"><table className="table table-striped api-table mb-0">
                    ...
                    <tbody>
                        ...
                        <tr><td style={{ paddingLeft: "28px" }}>&gt; username</td><td>string</td><td>Username</td></tr>
                        <tr><td style={{ paddingLeft: "28px" }}>&gt; memberType</td><td>integer</td><td><span className="pill">12</span>: custodial sub account</td></tr>
                        ...
                        <tr><td style={{ paddingLeft: "28px" }}>&gt; accountMode</td><td>integer</td><td><span className="pill">1</span>: Classic Account, <span className="pill">3</span>: UTA</td></tr>
