...
export const DepositToSubAcc = () => {
  ...
  "data": {
    ...
    const codeMap = {
        HTTP: `POST /futures/api/v1/deposit-to-sub-acc HTTP/1.1
...
url = "https://test.bitzup.com/futures/api/v1/deposit-to-sub-acc"
...
public class DepositToSubAccExample {
    public static void main(String[] args) throws Exception {
        ...
        HttpRequest request = HttpRequest.newBuilder()
            .uri(URI.create("https://test.bitzup.com/futures/api/v1/deposit-to-sub-acc"))
...
async function depositToSubAcc() {
  try {
    const response = await axios.post("https://test.bitzup.com/futures/api/v1/deposit-to-sub-acc",
      { coin: "USDT", amount: "100" },
      { headers: { "Content-Type": "application/json", Authorization: "Bearer <your_token>" } });
    ...
    return (
        <><div className="container-fluid p-0"><div className="api-layout"><div className="row">
            <div className="col-lg-9 col-md-12 api-content" ref={contentRef}>
                <div className="breadcrumb mb-4"><span className="kline-market">Private</span><span className="mx-2"><IoIosArrowForward className="kline-arrow" /></span><span className="pill">Deposit to Sub Account</span></div>
                <h1 className="api-title">Deposit to Sub Account</h1>
                <p className="api-desc">Transfer funds from the master account to a sub-account. The transfer is executed as a universal transfer on the UNIFIED account type.</p>
                ...
                <div className="http-path"><span className="method post">POST</span><span className="path">/v1/deposit-to-sub-acc</span></div>
                ...
                <div className="api-table-box"><table className="table table-striped api-table mb-0"><thead><tr><th>Parameter</th><th>Required</th><th>Type</th><th>Comments</th></tr></thead><tbody>
                    ...
                    <tr><td className="text-interval">amount</td><td>true</td><td>string</td><td>Amount to deposit</td></tr>
                </tbody></table></div>
