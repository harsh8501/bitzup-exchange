...
url = "https://test.bitzup.com/v5/system/status"
...
public class GetSystemStatus {
    public static void main(String[] args) throws Exception {
        ...
        HttpRequest request = HttpRequest.newBuilder()
                .uri(URI.create("https://test.bitzup.com/v5/system/status"))
                .GET()
                .build();
...
async function getSystemStatus() {
    try {
        const response = await axios.get('https://test.bitzup.com/v5/system/status');
            ...
            <div className="api-layout">
                <div className="row">
                    <div className="col-lg-9 col-md-12 api-content" ref={contentRef}>
                        ...
                        <h1 className="api-title" style={{ fontSize: "32px", marginBottom: "16px" }}>Get System Status</h1>
                        ...
                        <div className="http-path" style={{ background: "var(--bg-card)", padding: "12px 16px", borderRadius: "8px", display: "flex", gap: "12px", alignItems: "center", marginBottom: "32px" }}>
                            ...
                            <span className="path" style={{ fontWeight: "500", letterSpacing: "0.5px" }}>/v5/market/system-status</span>
                        </div>
