...
export const SwitchMarginMode = () => {
  ...
  "message": "your request has been accepted"
    ...
    const codeMap = {
        HTTP: `POST /futures/api/v1/switch-margin-mode HTTP/1.1
Host: api.bitzup.com
                    ...
                    <div className="row">
                        <div className="col-lg-9 col-md-12 api-content" ref={contentRef}>
                            <div className="breadcrumb mb-4">
                                ...
                                <span className="pill">Switch Margin Mode</span>
                            </div>

                            <h1 className="api-title">Switch Margin Mode</h1>
                            <p className="api-desc">
                                Switch between regular (cross) margin and isolated margin mode for
                                your account. This affects all positions under your account.
                            </p>
                            ...
                            <div className="http-path">
                                ...
                                <span className="path">/v1/switch-margin-mode</span>
                            </div>
