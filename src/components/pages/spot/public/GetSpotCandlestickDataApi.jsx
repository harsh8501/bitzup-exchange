...
export const GetSpotCandlestickDataApi = () => {
    ...
    <div className="api-doc-container">
      ...
      <div className="docs-panel" ref={contentRef}>
        <div className="breadcrumb">
          <span>Market</span> <IoIosArrowForward size={12} /> <span className="pill">Get Candlestick Data</span>
        </div>
        <h1 className="api-title">Get Candlestick Data</h1>
        <p style={{ color: "#888", marginBottom: "40px" }}>Get Candlestick Data (Kline) for a specified trading pair and time granularity.</p>
        ...
        <div className="api-box">
          ...
          <div className="tree-view">
            {[
              ...
              { name: "granularity", type: "string", req: true, desc: "Time interval e.g. 1min, 5min, 15min, 30min, 1h, 4h, 1day, 1week, 1M", values: ["1min", "3min", "5min", "15min", "30min", "1h", "4h", "6h", "12h", "1day", "3day", "1week", "1M"] },
              { name: "startTime", type: "string", req: false, desc: "Start timestamp (Unix millisecond timestamp, e.g. 1690196141868)" },
              { name: "endTime", type: "string", req: false, desc: "End timestamp (Unix millisecond timestamp, e.g. 1690196141868)" },
              { name: "limit", type: "string", req: false, desc: "Number of queries: Default: 100, maximum: 1000." },
            ].map(p => (
        ...
        <RequestQueryEditor requestBody={requestBody} setRequestBody={setRequestBody} requiredFields={["symbol", "granularity"]} />
...
export default GetSpotCandlestickDataApi;
