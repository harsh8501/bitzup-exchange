        ...
        <div className="row">
          <div className="col-lg-9 col-md-12 api-content" ref={contentRef}>
            ...
            <div className="api-info-box">
              ...
              <p>
                The acknowledgement of an amend order request indicates that the
                request was successfully accepted. This request is asynchronous,
                so please use the websocket to confirm the order status.
              </p>
            </div>
              ...
              <table className="table table-striped api-table mb-0">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>string</td>
                    <td>
                      Product type. <span className="pill">linear</span>
                    </td>
                  </tr>
                  <tr>
                    <td>symbol</td>
                    ...
                    <td>string</td>
                    <td>
                      Symbol name, like <span className="pill">BTCUSDT</span>,
                      uppercase only
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td>string</td>
                    <td>
                      Order ID. Either <span className="pill">orderId</span> or{" "}
                      <span className="pill">orderLinkId</span> is required
                    </td>
                  </tr>
                  <tr>
                    <td>orderLinkId</td>
                    ...
                    <td>
                      ...
                      <span className="pill">orderId</span> or{" "}
                      <span className="pill">orderLinkId</span> is required
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td>string</td>
                    <td>
                      Implied volatility. <span className="pill">option</span>{" "}
                      only. Pass the real value, e.g. for 10%, 0.1 should be
                      passed
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td>string</td>
                    <td>
                      Conditional order trigger price. If you expect the price
                      to rise to trigger, ensure{" "}
                      <span className="pill">triggerPrice</span> &gt; current
                      market price
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td>string</td>
                    <td>
                      Order quantity after modification. Do not pass it if not
                      modified
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td>string</td>
                    <td>
                      Order price after modification. Do not pass it if not
                      modified
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td>string</td>
                    <td>
                      TP/SL mode: <span className="pill">Full</span> (entire
                      position), <span className="pill">Partial</span> (partial
                      position). <span className="pill">linear</span> only
                    </td>
                  </tr>
                  <tr>
                    <td>takeProfit</td>
                    ...
                    <td>string</td>
                    <td>
                      Take profit price after modification. Pass{" "}
                      <span className="pill">"0"</span> to cancel existing TP.
                      Valid for <span className="pill">linear</span>
                    </td>
                  </tr>
                  <tr>
                    <td>stopLoss</td>
                    ...
                    <td>string</td>
                    <td>
                      Stop loss price after modification. Pass{" "}
                      <span className="pill">"0"</span> to cancel existing SL.
                      Valid for <span className="pill">linear</span>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td>
                      ...
                      <span className="pill">LastPrice</span>,{" "}
                      <span className="pill">IndexPrice</span>,{" "}
                      <span className="pill">MarkPrice</span>
                    </td>
                  </tr>
                  <tr>
                    <td>slTriggerBy</td>
                  ...
                  <tr>
                    ...
                    <td>false</td>
                    <td>string</td>
                    <td>TP limit price for partial limit TP/SL orders.</td>
                  </tr>
                  <tr>
                    <td>slLimitPrice</td>
                    <td>false</td>
                    <td>string</td>
                    <td>SL limit price for partial limit TP/SL orders.</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <div className="api-table-box">
              <table className="table table-striped api-table mb-0">
                ...
                <tbody>
                  ...
                  <tr>
                    <td style={{ paddingLeft: "28px" }}>&gt; orderId</td>
                    <td>string</td>
                    <td>Order ID</td>
                  </tr>
                  <tr>
                    <td style={{ paddingLeft: "28px" }}>&gt; orderLinkId</td>
                    <td>string</td>
            ...
            <div>
              <Link to={"/docs/v5/order/amend-order-api"} className="run-btn" style={{ marginBottom: "20px" }}>RUN &gt;&gt;</Link>
            </div>
