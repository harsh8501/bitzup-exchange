...
export const GetSubAccountAllApiKeysApi = () => {
    ...
    <div className="api-doc-container">
      ...
      <div className="docs-panel" ref={contentRef}>
        <div className="breadcrumb">
          <span>User</span> <IoIosArrowForward size={12} /> <span className="pill">Get Sub Account All API Keys</span>
        </div>
        <h1 className="api-title">Get Sub Account All API Keys</h1>
        <p style={{ color: "#888", marginBottom: "40px" }}>Query all API keys associated with a specific sub-account using your main account credentials.</p>

        <div className="api-box">
          <div className="api-box-header">Header Parameters</div>
          <div className="tree-view">
            {[
              { name: "apiKey", type: "string", req: true, desc: "Please use main account API key" },
              { name: "secret", type: "string", req: true, desc: "Please use main account secret key" },
            ].map(p => (
        ...
        <div className="api-box">
          ...
          <div className="tree-view">
            {[
              { name: "subMemberId", type: "string", req: true, desc: "The Sub UID of the account to query" },
              { name: "limit", type: "integer", desc: "Limit per page. Default 20, max 20" },
        ...
        <RequestQueryEditor requestBody={requestBody} setRequestBody={setRequestBody} requiredFields={["subMemberId"]} />
