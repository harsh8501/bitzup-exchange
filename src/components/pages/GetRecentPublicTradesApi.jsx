...
export const GetRecentPublicTradesApi = () => {
    ...
    <div className="api-doc-container">
      ...
      <div className="docs-panel" ref={contentRef}>
        <div className="breadcrumb">
          <span>Market</span> <IoIosArrowForward size={12} /> <span className="pill">Get Recent Public Trades</span>
        </div>
        <h1 className="api-title">Get Public Recent Trading History</h1>
        <p style={{ color: "#888", marginBottom: "40px" }}>Query the most recent executed trades on the public market.</p>
        ...
        <div className="api-box">
          ...
          <div className="tree-view">
            {[
              ...
              { name: "baseCoin", type: "string", desc: "Base coin (for option ONLY). Default: BTC" },
              { name: "optionType", type: "string", desc: "Option type (for option ONLY)", values: ["Call", "Put"] },
              { name: "limit", type: "integer", desc: "Limit per page. Max 60 for spot, max 1000 for others." },
            ].map(p => (
