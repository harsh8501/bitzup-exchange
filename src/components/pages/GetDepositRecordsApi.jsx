...
export const GetDepositRecordsApi = () => {
    ...
    <div className="api-doc-container">
      ...
      <div className="docs-panel" ref={contentRef}>
        <div className="breadcrumb">
          <span>Asset</span> <IoIosArrowForward size={12} /> <span className="pill">Get Deposit Record</span>
        </div>
        <h1 className="api-title">Get Deposit Record (on-chain)</h1>
        <p style={{ color: "#888", marginBottom: "40px" }}>Query your historical on-chain deposit records.</p>
        ...
        <div className="api-box">
          ...
          <div className="tree-view">
            {[
              { name: "coin", type: "string", desc: "Coin name (e.g., USDT, BTC, ETH)" },
              { name: "startTime", type: "integer", desc: "The start timestamp (ms)" },
              { name: "endTime", type: "integer", desc: "The end timestamp (ms)" },
              { name: "limit", type: "integer", desc: "Limit per page. Default 50, max 50" },
