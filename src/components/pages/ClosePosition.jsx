    ...
    return (
        <><div className="container-fluid p-0"><div className="api-layout"><div className="row">
            <div className="col-lg-9 col-md-12 api-content" ref={contentRef}>
                ...
                <div className="http-path"><span className="method post">POST</span><span className="path">/v1/close-position</span></div>
                ...
                <div className="api-table-box"><table className="table table-striped api-table mb-0"><thead><tr><th>Parameter</th><th>Required</th><th>Type</th><th>Comments</th></tr></thead><tbody>
                    ...
                    <tr><td className="text-interval">side</td><td>true</td><td>string</td><td>Opposite side of position. <span className="pill">Buy</span> or <span className="pill">Sell</span></td></tr>
                    ...
                    <tr><td className="text-interval">qty</td><td>true</td><td>number</td><td>Quantity to close</td></tr>
                    <tr><td>price</td><td>conditional</td><td>number</td><td>Required for <span className="pill">Limit</span> orders</td></tr>
                ...
                <div className="api-table-box"><table className="table table-striped api-table mb-0"><thead><tr><th>Parameter</th><th>Type</th><th>Comments</th></tr></thead><tbody>
                    <tr><td>orderId</td><td>string</td><td>Close order ID</td></tr>
