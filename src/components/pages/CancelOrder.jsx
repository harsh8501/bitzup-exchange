        ...
        <div className="row">
          <div className="col-lg-9 col-md-12 api-content" ref={contentRef}>
            <div className="breadcrumb mb-4">
              ...
              <span className="pill">Cancel Order</span>
            </div>
            ...
            <div className="api-info-box">
              ...
              <ul style={{ margin: 0, paddingLeft: "18px" }}>
                <li>
                  You must specify either <span className="pill">orderId</span>{" "}
                  or <span className="pill">orderLinkId</span> to cancel the
                  order.
                </li>
                <li>
                  If both <span className="pill">orderId</span> and{" "}
                  <span className="pill">orderLinkId</span> are provided but do
                  not match, the system will process the{" "}
                  <span className="pill">orderId</span> first.
                </li>
                <li>
                  The acknowledgement of a cancel order request indicates that
                  the request was successfully accepted. This request is
                  asynchronous; please use the websocket to confirm the actual
                  order status.
                </li>
              </ul>
            </div>
            ...
            <div className="http-path">
              ...
              <span className="path">/v5/order/cancel</span>
            </div>
              ...
              <table className="table table-striped api-table mb-0">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>string</td>
                    <td>
                      Symbol name, e.g. <span className="pill">BTCUSDT</span>,
                      uppercase only
                    </td>
                  </tr>
                  <tr>
