          ...
          <div className="row">
            ...
            <div className="col-lg-9 col-md-8 api-content" ref={contentRef}>
              ...
              <div className="breadcrumb mb-4">
                ...
                <span className="pill">Set Collateral Coin</span>
              </div>
              ...
              <div className="http-path">
                ...
                <span className="path">/v5/account/set-collateral-switch</span>
              </div>
                ...
                <table className="table table-striped api-table mb-0">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>true</td>
                      <td>string</td>
                      <td>Coin. Represented by multiple coins separated by comma, up to 10 coins. <span className="pill">USDT</span>, <span className="pill">USDC</span> cannot be set.</td>
                    </tr>
                    <tr>
