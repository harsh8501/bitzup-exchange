    ...
    <div className="api-doc-container">
      ...
      <div className="docs-panel" ref={contentRef}>
        <div className="breadcrumb">
          <span>Market</span> <IoIosArrowForward size={12} /> <span className="pill">Get Tickers</span>
        </div>
        <h1 className="api-title">Get Tickers</h1>
        <p style={{ color: "#888", marginBottom: "40px" }}>Query the latest price, volume, and other 24h ticker data for symbols.</p>
        ...
        <div className="api-box">
          ...
          <div className="tree-view">
            {[
              ...
              { name: "baseCoin", type: "string", desc: "Base coin (for option ONLY). If passed, it returns all tickers of the base coin." },
              { name: "expDate", type: "string", desc: "Expiry date (for option ONLY). Format: 25MAR22" },
            ].map(p => (
