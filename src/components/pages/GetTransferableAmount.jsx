          ...
          <div className="row">
            ...
            <div className="col-lg-9 col-md-8 api-content" ref={contentRef}>
              ...
              <div className="breadcrumb mb-4">
                ...
                <span className="pill">Get Transferable Amount (Unified)</span>
              </div>

              {/* Title */}
              <h1 className="api-title">Get Transferable Amount (Unified)</h1>
              ...
              <div className="http-path">
                ...
                <span className="path">/v5/account/withdrawal</span>
              </div>
              ...
              <div className="api-table-box">
                <table className="table table-striped api-table mb-0">
                  ...
                  <tbody>
                    <tr>
                      <td>availableWithdrawal</td>
                      <td>string</td>
                      <td>Available amount to withdraw of the first coin requested</td>
                    </tr>
                    <tr>
                      <td>availableWithdrawalMap</td>
                      <td>object</td>
                      <td>Map containing available withdrawal amount for all requested coins</td>
                    </tr>
                  </tbody>
                </table>
              </div>
