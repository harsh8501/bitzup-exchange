    ...
    <div className="api-doc-container">
      ...
      <div className="docs-panel" ref={contentRef}>
        <div className="breadcrumb">
          <span>Market</span> <IoIosArrowForward size={12} /> <span className="pill">Get Funding Rate History</span>
        </div>
        <h1 className="api-title">Get Funding Rate History</h1>
        <p style={{ color: "#888", marginBottom: "40px" }}>Query the historical funding rate for a specific symbol.</p>
        ...
        <div className="api-box">
          ...
          <div className="tree-view">
            {[
              ...
              { name: "limit", type: "integer", desc: "Limit per page. Default 200, max 200" },
            ].map(p => (
