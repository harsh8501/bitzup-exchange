    ...
    <div className="api-doc-container">
      ...
      <div className="docs-panel" ref={contentRef}>
        <div className="breadcrumb">
          <span>Position</span> <IoIosArrowForward size={12} /> <span className="pill">Set Leverage</span>
        </div>
        <h1 className="api-title">Set Leverage</h1>
        <p style={{ color: "#888", marginBottom: "40px" }}>Set the leverage of the specified symbol.</p>
        ...
        <div className="api-box">
          ...
          <div className="tree-view">
            {[
              ...
              { name: "buyLeverage", type: "string", req: true, desc: "Buy side leverage" },
              { name: "sellLeverage", type: "string", req: true, desc: "Sell side leverage" },
            ].map(p => (
              <div className="tree-item" key={p.name}>
                <span className="p-name">{p.name}</span>
                <span className="p-type">{p.type}</span>
        ...
        <RequestQueryEditor requestBody={requestBody} setRequestBody={setRequestBody} requiredFields={["category", "symbol", "buyLeverage", "sellLeverage"]} />
      ...
      <ApiExplorer
        requiredFields={["category", "symbol", "buyLeverage", "sellLeverage"]} 
        method="POST" 
