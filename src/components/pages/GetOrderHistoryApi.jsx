...
`}</style>
      ...
      <div className="docs-panel" ref={contentRef}>
        <div className="breadcrumb">
          <span>Trade</span> <IoIosArrowForward size={12} /> <span className="pill">Get Order History (2 years)</span>
        </div>
        <h1 className="api-title">Get Order History (2 years)</h1>
        <p style={{ color: "#888", marginBottom: "40px" }}>Query your order history.</p>
        ...
        <div className="api-box">
          ...
          <div className="tree-view">
            {[
              ...
              { name: "orderStatus", type: "string", desc: "Order status", values: ["Created", "New", "Rejected", "PartiallyFilled", "Filled", "Cancelled"] },
              { name: "orderFilter", type: "string", desc: "Order filter", values: ["Order", "StopOrder", "tpslOrder"] },
              { name: "limit", type: "integer", desc: "Limit per page. Default 20, max 50" },
