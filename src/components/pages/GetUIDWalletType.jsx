...
export const GetUIDWalletType = () => {
    ...
    "result": {
        "accounts": [
            {
                "uid": "123456789",
                "accountType": ["UNIFIED", "CONTRACT", "FUND"]
            }
        ]
    },
    "retExtInfo": {},
    ...
    return (
        <div className="container-fluid p-0"><div className="api-layout"><div className="row">
            <div className="col-lg-9 col-md-12 api-content" ref={contentRef}>
                <div className="breadcrumb mb-4"><span className="kline-market">User</span><span className="mx-2"><IoIosArrowForward className="kline-arrow" /></span><span className="pill">Get UID Wallet Type</span></div>
                <h1 className="api-title">Get UID Wallet Type</h1>
                <p className="api-desc">Get available wallet types for the master account or sub account.</p>
                <div className="api-cover">Requires Authentication</div>
                <h3 className="top-req-text" id="http">HTTP Request</h3>
                <div className="http-path"><span className="method get">GET</span><span className="path">/v5/user/get-member-type</span></div>
                ...
                <div className="api-table-box"><table className="table table-striped api-table mb-0">
                    ...
                    <tbody>
                        <tr><td>memberIds</td><td>false</td><td>string</td><td>Sub UID list, separate with comma. e.g., <span className="pill">"uid1,uid2,uid3"</span></td></tr>
                    </tbody>
                </table></div>
                ...
                <div className="api-table-box"><table className="table table-striped api-table mb-0">
                    ...
                    <tbody>
                        <tr><td>accounts</td><td>array</td><td>Object</td></tr>
                        <tr><td style={{ paddingLeft: "28px" }}>&gt; uid</td><td>string</td><td>Master/Sub UID</td></tr>
                        <tr><td style={{ paddingLeft: "28px" }}>&gt; accountType</td><td>array</td><td>Available wallet types, e.g., <span className="pill">["UNIFIED","CONTRACT","FUND"]</span></td></tr>
                    </tbody>
                </table></div>
                <div>
                  <Link to={"/docs/v5/user/wallet-type-api"} className="run-btn" style={{ marginBottom: "20px" }}>RUN &gt;&gt;</Link>
                </div>
