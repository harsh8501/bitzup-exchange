...
export const GetUIDWalletTypeApi = () => {
    ...
    <div className="api-doc-container">
      ...
      <div className="docs-panel" ref={contentRef}>
        <div className="breadcrumb">
          <span>User</span> <IoIosArrowForward size={12} /> <span className="pill">Get UID Wallet Type</span>
        </div>
        <h1 className="api-title">Get UID Wallet Type</h1>
        <p style={{ color: "#888", marginBottom: "40px" }}>Query the wallet type (e.g., Standard vs. Unified) for specific master or sub-account UIDs.</p>
        ...
        <div className="api-box">
          ...
          <div className="tree-view">
            {[
              { name: "memberIds", type: "string", desc: "Main UID or Sub UIDs (comma-separated for multiple)" },
            ].map(p => (
              <div className="tree-item" key={p.name}>
                <span className="p-name">{p.name}</span>
                <span className="p-type">{p.type}</span>
