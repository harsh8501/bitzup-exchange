    ...
    <div className="api-doc-container">
      ...
      <div className="docs-panel" ref={contentRef}>
        <div className="breadcrumb">
          <span>Trade</span> <IoIosArrowForward size={12} /> <span className="pill">Get Trade History (2 years)</span>
        </div>
        <h1 className="api-title">Get Trade History (2 years)</h1>
        <p style={{ color: "#888", marginBottom: "40px" }}>Query users' execution records, sorted by execTime in descending order.</p>
        ...
        <div className="api-box">
          ...
          <div className="tree-view">
            {[
              ...
              { name: "execType", type: "string", desc: "Execution type", values: ["Trade", "AdlTrade", "Funding", "BustTrade", "Settle"] },
              { name: "limit", type: "integer", desc: "Limit per page. Default 50, max 100" },
