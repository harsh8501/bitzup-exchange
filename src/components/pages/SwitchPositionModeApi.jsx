    ...
    <div className="api-doc-container">
      ...
      <div className="docs-panel" ref={contentRef}>
        <div className="breadcrumb">
          <span>Position</span> <IoIosArrowForward size={12} /> <span className="pill">Switch Position Mode</span>
        </div>
        <h1 className="api-title">Switch Position Mode</h1>
        <p style={{ color: "#888", marginBottom: "40px" }}>Switch between One-Way and Hedge modes.</p>
