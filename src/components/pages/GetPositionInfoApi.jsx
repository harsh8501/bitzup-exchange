...
export const GetPositionInfoApi = () => {
    ...
    <div className="api-doc-container">
      ...
      <div className="docs-panel" ref={contentRef}>
        <div className="breadcrumb">
          <span>Position</span> <IoIosArrowForward size={12} /> <span className="pill">Get Position Info</span>
        </div>
        <h1 className="api-title">Get Position Info</h1>
        <p style={{ color: "#888", marginBottom: "40px" }}>Query real-time position data.</p>
        ...
        <div className="api-box">
          ...
          <div className="tree-view">
            {[
              { name: "category", type: "string", req: true, desc: "Product type", values: ["linear", "inverse", "option"] },
              { name: "symbol", type: "string", desc: "Symbol name" },
              { name: "baseCoin", type: "string", desc: "Base coin. For option only" },
              { name: "settleCoin", type: "string", desc: "Settle coin. Used for linear & inverse" },
              { name: "limit", type: "integer", desc: "Limit per page. Default 20, max 200" },
