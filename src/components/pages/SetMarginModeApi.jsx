    ...
    <div className="api-doc-container">
      ...
      <div className="docs-panel" ref={contentRef}>
        <div className="breadcrumb">
          <span>Account</span> <IoIosArrowForward size={12} /> <span className="pill">Set Margin Mode</span>
        </div>
        <h1 className="api-title">Set Margin Mode</h1>
        <p style={{ color: "#888", marginBottom: "40px" }}>Configure the margin mode for your account.</p>
        ...
        <div className="api-box">
          ...
          <div className="tree-view">
            {[
              { name: "setMarginMode", type: "string", req: true, desc: "Margin mode", values: ["REGULAR_MARGIN", "ISOLATED_MARGIN", "PORTFOLIO_MARGIN"] },
            ].map(p => (
              <div className="tree-item" key={p.name}>
                <span className="p-name">{p.name}</span>
                <span className="p-type">{p.type}</span>
