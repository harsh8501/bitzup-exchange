    ...
    <div className="api-doc-container">
      ...
      <div className="docs-panel" ref={contentRef}>
        <div className="breadcrumb">
          <span>Account</span> <IoIosArrowForward size={12} /> <span className="pill">Get Account Info</span>
        </div>
        <h1 className="api-title">Get Account Info</h1>
        <p style={{ color: "#888", marginBottom: "40px" }}>Query your account's configuration and current status details.</p>
