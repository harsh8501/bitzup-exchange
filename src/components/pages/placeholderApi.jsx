...
export const PlaceOrderApi = () => {
  ...
  const codeMap = {
    cURL: `curl -L -X POST 'https://api-testnet.bybit.com/v5/order/create' \
...
url = URI("https://api-testnet.bybit.com/v5/order/create")
...
--data-raw '{
    ...
    <div className="api-doc-container">
        ...
        <div className="api-box">
          ...
          <div className="tree-view">
            ...
            <div className="tree-item">
              ...
              <span className="p-type">string</span>
              <p className="p-desc">param for StopOrder</p>
            </div>

            <div className="tree-item">
              <span className="p-name">triggerDirection</span>
              <span className="p-type">integer</span>
              <div className="val-pills">
                <span>Possible values:</span>
                <span className="val-pill">1</span>
                <span className="val-pill">2</span>
              </div>
              <p className="p-desc">param for StopOrder. 1=rise, 2=fall</p>
            </div>
            ...
            <div className="tree-item">
              <span className="p-name">orderFilter</span>
              <span className="p-type">string</span>
              <div className="val-pills">
                <span>Possible values:</span>
                <span className="val-pill">Order</span>
                <span className="val-pill">tpslOrder</span>
                <span className="val-pill">StopOrder</span>
              </div>
              <span className="default-pill">Default value: Order</span>
              <p className="p-desc">
                Take profit stop loss, normal order or conditional order. Only
                valid for spot.
              </p>
            </div>

            <div className="tree-item">
              <span className="p-name">orderIv</span>
              <span className="p-type">string</span>
              <p className="p-desc">
            ...
            <div className="tree-item">
              <span className="p-name">timeInForce</span>
              <span className="p-type">string</span>
              <div className="val-pills">
                <span>Possible values:</span>
                <span className="val-pill">GTC</span>
                <span className="val-pill">IOC</span>
                <span className="val-pill">FOK</span>
                <span className="val-pill">PostOnly</span>
              </div>
              <p className="p-desc">Time in force</p>
            </div>

            <div className="tree-item">
              <span className="p-name">positionIdx</span>
              <span className="p-type">integer</span>
              <div className="val-pills">
                <span>Possible values:</span>
                <span className="val-pill">0</span>
            ...
            <div className="tree-item">
              <span className="p-name">orderLinkId</span>
              <span className="p-type">string</span>
              <p className="p-desc">required param for option order</p>
            </div>

            <div className="tree-item">
              <span className="p-name">takeProfit</span>
              <span className="p-type">string</span>
              <p className="p-desc">Take profit price</p>
            </div>

            <div className="tree-item">
              <span className="p-name">stopLoss</span>
              <span className="p-type">string</span>
              <p className="p-desc">Stop loss price</p>
            </div>
            ...
            <div className="tree-item">
              ...
              <p className="p-desc">Trigger take profit price price type</p>
            </div>
            ...
            <div className="tree-item">
              ...
              <p className="p-desc">Trigger stop loss price price type</p>
            </div>

            <div className="tree-item">
              <span className="p-name">reduceOnly</span>
              <span className="p-type">boolean</span>
              <div className="val-pills">
                <span>Possible values:</span>
                <span className="val-pill">true</span>
                <span className="val-pill">false</span>
              </div>
              <p className="p-desc">specify true if a close position order</p>
            </div>

            <div className="tree-item">
              <span className="p-name">closeOnTrigger</span>
              <span className="p-type">boolean</span>
              <div className="val-pills">
                <span>Possible values:</span>
                <span className="val-pill">true</span>
              ...
              <p className="p-desc">close on trigger</p>
            </div>

            <div className="tree-item">
              <span className="p-name">smpType</span>
              <span className="p-type">string</span>
              <div className="val-pills">
                <span>Possible values:</span>
                <span className="val-pill">None</span>
                <span className="val-pill">CancelMaker</span>
                <span className="val-pill">CancelTaker</span>
                <span className="val-pill">CancelBoth</span>
              </div>
              <p className="p-desc">Smp execution type</p>
            </div>

            <div className="tree-item">
              <span className="p-name">mmp</span>
              <span className="p-type">boolean</span>
              <div className="val-pills">
                <span>Possible values:</span>
                <span className="val-pill">true</span>
            ...
            <div className="tree-item">
              ...
              <p className="p-desc">TP/SL mode</p>
            </div>
            ...
            <div className="tree-item">
              <span className="p-name">tpOrderType</span>
              <span className="p-type">string</span>
              <div className="val-pills">
                <span>Possible values:</span>
                <span className="val-pill">Market</span>
            ...
            <div className="tree-item">
              <span className="p-name">slOrderType</span>
              <span className="p-type">string</span>
              <div className="val-pills">
                <span>Possible values:</span>
                <span className="val-pill">Market</span>
      ...
      <div className="explorer-panel">
        <div className="endpoint-header">
          ...
          <span className="endpoint-path">/v5/order/create</span>
        </div>
  ...
  "`}
            ...
            {`",
  "`}
            <span className="syntax-key">isLeverage</span>
            {`": `}
            <span className="syntax-num">0</span>
            {`,
  "`}
            <span className="syntax-key">side</span>
            {`": "`}
            <span className="syntax-str">Buy</span>
            {`",
  "`}
            <span className="syntax-key">orderType</span>
            {`": "`}
            <span className="syntax-str">Limit</span>
            {`",
  "`}
            <span className="syntax-key">qty</span>
            {`": "`}
            <span className="syntax-str">1</span>
            {`",
  "`}
            <span className="syntax-key">price</span>
            {`": "`}
            <span className="syntax-str">1000</span>
            {`",
  "`}
            <span className="syntax-key">triggerPrice</span>
            {`": `}
            <span className="syntax-num">null</span>
            {`,
  "`}
            <span className="syntax-key">triggerDirection</span>
            {`": `}
            <span className="syntax-num">null</span>
            {`,
  "`}
            <span className="syntax-key">triggerBy</span>
            {`": `}
            <span className="syntax-num">null</span>
            {`,
  "`}
            <span className="syntax-key">orderFilter</span>
            {`": `}
            <span className="syntax-num">null</span>
            {`,
  "`}
            <span className="syntax-key">orderIv</span>
            {`": `}
            <span className="syntax-num">null</span>
            {`,
  "`}
            <span className="syntax-key">timeInForce</span>
            {`": "`}
            <span className="syntax-str">GTC</span>
            {`",
  "`}
            <span className="syntax-key">positionIdx</span>
            {`": `}
            <span className="syntax-num">0</span>
            {`,
  "`}
            ...
            {`",
  "`}
            <span className="syntax-key">takeProfit</span>
            {`": `}
            <span className="syntax-num">null</span>
            {`,
  "`}
            <span className="syntax-key">stopLoss</span>
            {`": `}
            <span className="syntax-num">null</span>
            {`,
  "`}
            <span className="syntax-key">tpTriggerBy</span>
            {`": `}
            <span className="syntax-num">null</span>
            {`,
  "`}
            <span className="syntax-key">slTriggerBy</span>
            {`": `}
            <span className="syntax-num">null</span>
            {`,
  "`}
            <span className="syntax-key">reduceOnly</span>
            {`": `}
            <span className="syntax-num">false</span>
            {`,
  "`}
            <span className="syntax-key">closeOnTrigger</span>
            {`": `}
            <span className="syntax-num">false</span>
            {`,
  "`}
            <span className="syntax-key">smpType</span>
            {`": `}
            <span className="syntax-num">null</span>
            {`,
  "`}
            <span className="syntax-key">mmp</span>
            {`": `}
            <span className="syntax-num">null</span>
            {`,
  "`}
            <span className="syntax-key">tpslMode</span>
            {`": `}
            <span className="syntax-num">null</span>
            {`,
  "`}
            <span className="syntax-key">tpLimitPrice</span>
            {`": `}
            <span className="syntax-num">null</span>
            {`,
  "`}
            <span className="syntax-key">slLimitPrice</span>
            {`": `}
            <span className="syntax-num">null</span>
            {`,
  "`}
            <span className="syntax-key">tpOrderType</span>
            {`": `}
            <span className="syntax-num">null</span>
            {`,
  "`}
            <span className="syntax-key">slOrderType</span>
            {`": `}
            <span className="syntax-num">null</span>
            {`
}`}
