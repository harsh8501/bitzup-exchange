    ...
    <div className="api-doc-container">
      ...
      <div className="docs-panel" ref={contentRef}>
        <div className="breadcrumb">
          <span>Account</span> <IoIosArrowForward size={12} /> <span className="pill">Get Fee Rate</span>
        </div>
        <h1 className="api-title">Get Fee Rate</h1>
        <p style={{ color: "#888", marginBottom: "40px" }}>Query your trading fee rates for different categories and symbols.</p>
