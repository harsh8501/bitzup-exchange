...
export const GetSpotRecentTradesApi = () => {
    ...
    <div className="api-doc-container">
      ...
      <div className="docs-panel" ref={contentRef}>
        <div className="breadcrumb">
          <span>Market</span> <IoIosArrowForward size={12} /> <span className="pill">Get Recent Trades</span>
        </div>
        <h1 className="api-title">Get Recent Trades</h1>
        <p style={{ color: "#888", marginBottom: "40px" }}>Get Recent Trades for a specified trading pair.</p>
        ...
        <div className="api-box">
          ...
          <div className="tree-view">
            {[
              ...
              { name: "limit", type: "string", req: false, desc: "Default: 100, maximum: 500" },
            ].map(p => (
...
export default GetSpotRecentTradesApi;
