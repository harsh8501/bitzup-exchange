          ...
          <div className="row">
            ...
            <div className="col-lg-9 col-md-8 api-content" ref={contentRef}>
              ...
              <div className="breadcrumb mb-4">
                ...
                <span className="pill">Get Instruments Info</span>
              </div>
                ...
                <table className="table table-striped api-table mb-0">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>false</td>
                      <td>string</td>
                      <td>Symbol type. If given, we will strictly filter instruments that match the request</td>
                    </tr>
                    <tr>
                      <td>status</td>
                      <td>false</td>
                ...
                <table className="table table-striped api-table mb-0">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>list</td>
                      <td>array</td>
                      <td>An array of instrument objects.</td>
                    </tr>
                    <tr>
                      <td>&gt; symbol</td>
                      <td>string</td>
              ...
              <div>
                <Link to={"/docs/v5/market/instruments-info-api"} className="run-btn" style={{ marginBottom: "20px" }}>RUN &gt;&gt;</Link>
              </div>
