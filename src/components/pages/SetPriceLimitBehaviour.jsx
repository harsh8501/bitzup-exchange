...
export const SetPriceLimitBehaviour = () => {
          ...
          <div className="row">
            ...
            <div className="col-lg-9 col-md-8 api-content" ref={contentRef}>
              ...
              <div className="breadcrumb mb-4">
                ...
                <span className="pill">Set Price Limit Behaviour</span>
              </div>

              {/* Title */}
              <h1 className="api-title">Set Price Limit Behaviour</h1>
              ...
              <div className="http-path">
                ...
                <span className="path">/v5/account/set-limit-px-action</span>
              </div>
