...
export const GetTradeBehaviourConfig = () => {
          ...
          <div className="row">
            ...
            <div className="col-lg-9 col-md-8 api-content" ref={contentRef}>
              ...
              <div className="breadcrumb mb-4">
                ...
                <span className="pill">Get Trade Behaviour Config</span>
              </div>

              {/* Title */}
              <h1 className="api-title">Get Trade Behaviour Config</h1>
              ...
              <div className="http-path">
                ...
                <span className="path">/v5/account/user-setting-config</span>
              </div>
