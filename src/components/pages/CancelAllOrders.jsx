...
export const CancelAllOrders = () => {
  ...
  "message": {
    ...
    const codeMap = {
        HTTP: `POST /futures/api/v1/cancel-all-order HTTP/1.1
Host: api.bitzup.com
    ...
    return (
        <><div className="container-fluid p-0"><div className="api-layout"><div className="row">
            <div className="col-lg-9 col-md-12 api-content" ref={contentRef}>
                <div className="breadcrumb mb-4"><span className="kline-market">Private</span><span className="mx-2"><IoIosArrowForward className="kline-arrow" /></span><span className="pill">Cancel All Orders</span></div>
                <h1 className="api-title">Cancel All Orders</h1>
                <p className="api-desc">Cancel all open orders for a given settlement coin. You can filter by order type: <code>Limit</code>, <code>tpslOrder</code>, or <code>trailingStop</code>.</p>
                ...
                <div className="http-path"><span className="method post">POST</span><span className="path">/v1/cancel-all-order</span></div>
                ...
                <div className="api-table-box"><table className="table table-striped api-table mb-0"><thead><tr><th>Parameter</th><th>Required</th><th>Type</th><th>Comments</th></tr></thead><tbody>
                    <tr><td className="text-interval">quote_coin</td><td>true</td><td>string</td><td>Settlement coin, e.g. <span className="pill">USDT</span></td></tr>
                    <tr><td className="text-interval">order_type</td><td>true</td><td>string</td><td><span className="pill">Limit</span>, <span className="pill">tpslOrder</span>, or <span className="pill">trailingStop</span></td></tr>
                </tbody></table></div>
                ...
                <div className="api-table-box"><table className="table table-striped api-table mb-0"><thead><tr><th>Parameter</th><th>Type</th><th>Comments</th></tr></thead><tbody>
                    ...
                    <tr><td>message</td><td>object</td><td>Contains list of cancelled orders and success status</td></tr>
                </tbody></table></div>
