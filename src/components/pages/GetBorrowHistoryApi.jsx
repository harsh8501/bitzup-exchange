    ...
    <div className="api-doc-container">
      ...
      <div className="docs-panel" ref={contentRef}>
        <div className="breadcrumb">
          <span>Account</span> <IoIosArrowForward size={12} /> <span className="pill">Get Borrow History</span>
        </div>
        <h1 className="api-title">Get Borrow History</h1>
        <p style={{ color: "#888", marginBottom: "40px" }}>Query historical borrowing data for your account.</p>
        ...
        <div className="api-box">
          ...
          <div className="tree-view">
            {[
              { name: "currency", type: "string", desc: "Currency name, e.g., USDC, USDT, BTC, ETH" },
