    ...
    <div className="api-doc-container">
      ...
      <div className="docs-panel" ref={contentRef}>
        <div className="breadcrumb">
          <span>Asset</span> <IoIosArrowForward size={12} /> <span className="pill">Get Coin Info</span>
        </div>
        <h1 className="api-title">Get Coin Info</h1>
        <p style={{ color: "#888", marginBottom: "40px" }}>Query detailed metadata and status information for a specific coin.</p>
        ...
        <div className="api-box">
          ...
          <div className="tree-view">
            {[
              { name: "coin", type: "string", desc: "Coin name (e.g., BTC, ETH, USDT)" },
            ].map(p => (
              <div className="tree-item" key={p.name}>
                <span className="p-name">{p.name}</span>
                <span className="p-type">{p.type}</span>
