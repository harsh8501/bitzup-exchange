...
export const AutoIsolatedMargin = () => {
  ...
  "message": "your request has been accepted"
    ...
    const codeMap = {
        HTTP: `POST /futures/api/v1/auto-isolated-margin HTTP/1.1
Host: api.bitzup.com
                    ...
                    <div className="row">
                        <div className="col-lg-9 col-md-12 api-content" ref={contentRef}>
                            <div className="breadcrumb mb-4">
                                ...
                                <span className="pill">Auto Isolated Margin</span>
                            </div>

                            <h1 className="api-title">Auto Isolated Margin</h1>
                            <p className="api-desc">
                                Turn on or off the auto-add-margin feature for isolated margin positions.
                                When enabled, the system automatically adds margin from your available balance
                            ...
                            <div className="http-path">
                                ...
                                <span className="path">/v1/auto-isolated-margin</span>
                            </div>
                                ...
                                <table className="table table-striped api-table mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><span className="pill">0</span> to turn off, <span className="pill">1</span> to turn on</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
