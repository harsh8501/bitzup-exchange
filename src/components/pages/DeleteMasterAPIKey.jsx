...
export const DeleteMasterAPIKey = () => {
    ...
    return (
        <div className="container-fluid p-0"><div className="api-layout"><div className="row">
            <div className="col-lg-9 col-md-12 api-content" ref={contentRef}>
                <div className="breadcrumb mb-4"><span className="kline-market">User</span><span className="mx-2"><IoIosArrowForward className="kline-arrow" /></span><span className="pill">Delete Master API Key</span></div>
                <h1 className="api-title">Delete Master API Key</h1>
                <p className="api-desc">Delete the api key of master account. Use the api key pending to be delete to call the endpoint. Use master user's api key only.</p>
                ...
                <div className="api-caution mb-3"><strong>CAUTION:</strong> BE CAREFUL! The API key used to call this interface will be invalid immediately.</div>
                <div className="api-cover">Requires Authentication</div>
                <h3 className="top-req-text" id="http">HTTP Request</h3>
                <div className="http-path"><span className="method post">POST</span><span className="path">/v5/user/delete-api</span></div>
