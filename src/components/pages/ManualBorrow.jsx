          ...
          <div className="row">
            ...
            <div className="col-lg-9 col-md-8 api-content" ref={contentRef}>
              ...
              <div className="breadcrumb mb-4">
                ...
                <span className="pill">Manual Borrow</span>
              </div>

              {/* Title */}
              <h1 className="api-title">Manual Borrow</h1>
              ...
              <div className="http-path">
                ...
                <span className="path">/v5/account/borrow</span>
              </div>
                ...
                <table className="table table-striped api-table mb-0">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>amount</td>
                      <td>string</td>
                      <td>Successful borrow amount</td>
                    </tr>
                  </tbody>
                </table>
              </div>
