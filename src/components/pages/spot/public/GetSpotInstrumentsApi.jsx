...
export const GetSpotInstrumentsApi = () => {
    ...
    <div className="api-doc-container">
      ...
      <div className="docs-panel" ref={contentRef}>
        <div className="breadcrumb">
          <span>Market</span> <IoIosArrowForward size={12} /> <span className="pill">Get Instruments</span>
        </div>
        <h1 className="api-title">Get Instruments</h1>
        <p style={{ color: "#888", marginBottom: "40px" }}>Query the specifications for online trading pair instruments.</p>

        <div className="api-box">
          <div className="api-box-header">Query Parameters</div>
          <div className="tree-view">
            {[
              { name: "category", type: "string", req: true, desc: "Product type: SPOT, MARGIN, USDT-FUTURES, COIN-FUTURES, USDC-FUTURES", values: ["SPOT", "MARGIN", "USDT-FUTURES", "COIN-FUTURES", "USDC-FUTURES"] },
              { name: "symbol", type: "string", req: false, desc: "Symbol name e.g. BTCUSDT" },
            ].map(p => (
...
export default GetSpotInstrumentsApi;
