...
export const ModifyMasterAPIKey = () => {
    ...
    const codeMap = {
        HTTP: `POST /v5/user/update-api HTTP/1.1
Host: api.bitzup.com
    ...
    return (
        <div className="container-fluid p-0"><div className="api-layout"><div className="row">
            <div className="col-lg-9 col-md-12 api-content" ref={contentRef}>
                <div className="breadcrumb mb-4"><span className="kline-market">User</span><span className="mx-2"><IoIosArrowForward className="kline-arrow" /></span><span className="pill">Modify Master API Key</span></div>
                <h1 className="api-title">Modify Master API Key</h1>
                <p className="api-desc">Modify the settings of master api key. Use the api key pending to be modified to call the endpoint. Use master user's api key only.</p>
                ...
                <div className="http-path"><span className="method post">POST</span><span className="path">/v5/user/update-api</span></div>
                ...
                <div className="api-table-box"><table className="table table-striped api-table mb-0">
                    ...
                    <tbody>
                        ...
                        <tr><td>ips</td><td>false</td><td>array</td><td>Set the IP bind. e.g., <code>["xxx.xxx.xxx.xxx"]</code>. <code>["*"]</code> means no restriction</td></tr>
                        ...
                        <tr><td style={{ paddingLeft: "28px" }}>&gt; Wallet</td><td>false</td><td>array</td><td><code>"AccountTransfer"</code>, <code>"SubMemberTransfer"</code>, <code>"SubMemberTransferList"</code>, <code>"Withdraw"</code></td></tr>
