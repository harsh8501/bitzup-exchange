...
export const GetSpotTickerInfoApi = () => {
    ...
    <div className="api-doc-container">
      ...
      <div className="docs-panel" ref={contentRef}>
        <div className="breadcrumb">
          <span>Market</span> <IoIosArrowForward size={12} /> <span className="pill">Get Ticker Information</span>
        </div>
        <h1 className="api-title">Get Ticker Information</h1>
        <p style={{ color: "#888", marginBottom: "40px" }}>Get Ticker Information, Supports both single and batch queries.</p>
...
export default GetSpotTickerInfoApi;
