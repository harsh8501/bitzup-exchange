          ...
          <div className="row">
            <div className="col-lg-9 col-md-12 api-content" ref={contentRef}>
              ...
              <div className="breadcrumb mb-4">
                ...
                <span className="pill">Get Index Price Kline</span>
              </div>
              ...
              <div className="http-path">
                ...
                <span className="path">/v5/market/index-price-kline</span>
              </div>
...
<div><Link to={"/docs/v5/market/index-price-kline-api"} className="run-btn" style={{ marginBottom: "20px" }}>RUN &gt;&gt;</Link></div>
              {/* REQUEST EXAMPLE */}
