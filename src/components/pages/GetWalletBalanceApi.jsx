    ...
    <div className="api-doc-container">
      ...
      <div className="docs-panel" ref={contentRef}>
        <div className="breadcrumb">
          <span>Account</span> <IoIosArrowForward size={12} /> <span className="pill">Get Wallet Balance</span>
        </div>
        <h1 className="api-title">Get Wallet Balance</h1>
        <p style={{ color: "#888", marginBottom: "40px" }}>Query real-time wallet balance for different account types.</p>
