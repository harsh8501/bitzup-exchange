    ...
    <div className="api-doc-container">
      ...
      <div className="docs-panel" ref={contentRef}>
        <div className="breadcrumb">
          <span>Trade</span> <IoIosArrowForward size={12} /> <span className="pill">Amend Order</span>
        </div>
        ...
        <div className="api-box">
          ...
          <div className="tree-view">
            {[
              ...
              { name: "qty", type: "string", desc: "Order quantity after modification" },
              { name: "price", type: "string", desc: "Order price after modification" },
              { name: "triggerPrice", type: "string", desc: "For conditional orders only" },
