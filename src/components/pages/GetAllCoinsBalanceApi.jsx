    ...
    <div className="api-doc-container">
      ...
      <div className="docs-panel" ref={contentRef}>
        <div className="breadcrumb">
          <span>Asset</span> <IoIosArrowForward size={12} /> <span className="pill">Get All Coins Balance</span>
        </div>
        <h1 className="api-title">Get All Coins Balance</h1>
        <p style={{ color: "#888", marginBottom: "40px" }}>Query the balance of all coins across different account types for master or sub accounts.</p>

        <div className="api-box">
          <div className="api-box-header">Header Parameters</div>
          <div className="tree-view">
            {[
              { name: "apiKey", type: "string", req: true, desc: "Use master UID api key" },
              { name: "secret", type: "string", req: true, desc: "Use master UID api secret" },
            ].map(p => (
