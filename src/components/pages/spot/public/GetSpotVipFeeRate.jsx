...
export const GetSpotVipFeeRate = () => {
  ...
  const codeMap = {
    HTTP: `curl "https://api.bitget.com/api/v2/spot/market/vip-fee-rate"`,
    Python: `import requests

url = "https://api.bitget.com/api/v2/spot/market/vip-fee-rate"
...
public class GetSpotVipFeeRateDemo {
    public static void main(String[] args) throws Exception {
        String url = "https://api.bitget.com/api/v2/spot/market/vip-fee-rate";
...
async function getSpotVipFeeRate() {
    try {
        const response = await axios.get('https://api.bitget.com/api/v2/spot/market/vip-fee-rate');
        ...
        <div className="row">
          ...
          <div className="col-lg-9 col-md-8 api-content" ref={contentRef}>
            ...
            <div className="breadcrumb mb-4">
              ...
              <span className="pill">Get VIP Fee Rate</span>
            </div>
            ...
            <p className="api-desc">
              Get VIP Fee Rate parameters for spot trading.
            </p>
            ...
            <div className="http-path mb-4">
              ...
              <span className="path">/api/v2/spot/market/vip-fee-rate</span>
            </div>
            ...
            <p style={{ color: "#8b949e", fontSize: "14px", marginBottom: "24px" }}>N/A</p>
              ...
              <table className="table table-striped api-table mb-0">
                ...
                <tbody>
                  ...
                  <tr>
                    <td>&gt; dealAmount</td>
                    <td>String</td>
                    <td>Total trading volume in last 30 days, USDT</td>
                  </tr>
                  <tr>
                    <td>&gt; assetAmount</td>
                    <td>String</td>
                    <td>Total assets in USDT</td>
                  </tr>
                  <tr>
                    <td>&gt; takerFeeRate</td>
                    <td>String</td>
                    <td>Taker fee. Refer to the official announcement for the real rate when 0 is shown.</td>
                  </tr>
                  <tr>
                    <td>&gt; makerFeeRate</td>
                    <td>String</td>
                    <td>Maker fee. Refer to the official announcement for the real rate when 0 is shown.</td>
                  </tr>
                  <tr>
                    <td>&gt; btcWithdrawAmount</td>
                    <td>String</td>
                    <td>24-hour withdrawal limit in BTC</td>
                  </tr>
                  <tr>
                    <td>&gt; usdtWithdrawAmount</td>
                    <td>String</td>
                    <td>24-hour withdrawal limit in USDT</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <div>
              <Link to={"/docs/spot/market/vip-fee-rate-api"} className="run-btn" style={{ marginBottom: "20px" }}>RUN &gt;&gt;</Link>
            </div>
...
export default GetSpotVipFeeRate;
