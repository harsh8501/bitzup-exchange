        ...
        <div className="row">
          <div className="col-lg-9 col-md-12 api-content" ref={contentRef}>
            <div className="breadcrumb mb-4">
              <span className="kline-market">Position</span>
              <span className="mx-2">
                <IoIosArrowForward className="kline-arrow" />
              </span>
              <span className="pill">Get Move Position History</span>
            </div>
            ...
            <div className="http-path">
              ...
              <span className="path">/v5/position/move-history</span>
            </div>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <span className="pill">Filled</span>,{" "}
                  ...
                  <tr>
                    ...
                    <td>integer</td>{" "}
                    <td>
                      Limit [<span className="pill">1</span>,
              ...
              <table className="table table-striped api-table mb-0">
                ...
                <tbody>
                  ...
                  <tr>
                    <td>list</td>
                    <td>array</td>
                    <td>Move position history list</td>
                  </tr>
                  <tr>
                    <td style={{ paddingLeft: "28px" }}>&gt; blockTradeId</td>
                    <td>string</td>
                    <td>Block trade ID</td>
                  </tr>
                  <tr>
                    <td style={{ paddingLeft: "28px" }}>&gt; category</td>
                    <td>string</td>
                    <td>Product type</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td style={{ paddingLeft: "28px" }}>&gt; userId</td>
                    <td>integer</td>
                    <td>User ID</td>
                  </tr>
                  <tr>
                    <td style={{ paddingLeft: "28px" }}>&gt; symbol</td>
                    <td>string</td>
                    <td>Symbol name</td>
                  </tr>
                  <tr>
                    <td style={{ paddingLeft: "28px" }}>&gt; side</td>
                    <td>string</td>
                    <td>
                      <span className="pill">Buy</span>,{" "}
                      <span className="pill">Sell</span>
                    </td>
                  </tr>
                  <tr>
                    <td style={{ paddingLeft: "28px" }}>&gt; price</td>
                    <td>string</td>
                    <td>Trade price</td>
                  </tr>
                  <tr>
                    <td style={{ paddingLeft: "28px" }}>&gt; qty</td>
                    <td>string</td>
                    <td>Trade quantity</td>
                  </tr>
                  <tr>
                    <td style={{ paddingLeft: "28px" }}>&gt; execFee</td>
                    <td>string</td>
                    <td>Execution fee</td>
                  </tr>
                  <tr>
                    <td style={{ paddingLeft: "28px" }}>&gt; status</td>
                    <td>string</td>
                    <td>
                      <span className="pill">Processing</span>,{" "}
                      <span className="pill">Filled</span>,{" "}
                  ...
                  <tr>
                    <td style={{ paddingLeft: "28px" }}>&gt; execId</td>
                    <td>string</td>
                    <td>Execution ID</td>
                  </tr>
                  <tr>
                    <td style={{ paddingLeft: "28px" }}>&gt; resultCode</td>
                    <td>integer</td>
                    <td>Result code. 0 means success</td>
                  </tr>
                  <tr>
                    <td style={{ paddingLeft: "28px" }}>&gt; resultMessage</td>
                    <td>string</td>
                    <td>Result message</td>
                  </tr>
                  <tr>
                    <td style={{ paddingLeft: "28px" }}>&gt; createdAt</td>
                    <td>number</td>
                    <td>Created timestamp (ms)</td>
                  </tr>
                  <tr>
                    <td style={{ paddingLeft: "28px" }}>&gt; updatedAt</td>
                    <td>number</td>
                    <td>Updated timestamp (ms)</td>
                  </tr>
                </tbody>
              </table>
            </div>
