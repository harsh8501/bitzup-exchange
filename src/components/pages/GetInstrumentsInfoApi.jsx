    ...
    <div className="api-doc-container">
      ...
      <div className="docs-panel" ref={contentRef}>
        <div className="breadcrumb">
          <span>Market</span> <IoIosArrowForward size={12} /> <span className="pill">Get Instrument Info</span>
        </div>
        <h1 className="api-title">Get Instrument Info</h1>
        <p style={{ color: "#888", marginBottom: "40px" }}>Query the detailed configuration of trading instruments across different market categories.</p>
        ...
        <div className="api-box">
          ...
          <div className="tree-view">
            {[
              ...
              { name: "limit", type: "integer", desc: "Limit per page. Default 500, max 1000" },
