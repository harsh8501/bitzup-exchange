    ...
    <div className="api-doc-container">
      ...
      <div className="docs-panel" ref={contentRef}>
        <div className="breadcrumb">
          <span>Account</span> <IoIosArrowForward size={12} /> <span className="pill">Set Collateral Coin</span>
        </div>
        <h1 className="api-title">Set Collateral Coin</h1>
        <p style={{ color: "#888", marginBottom: "40px" }}>Enable or disable a specific coin as collateral.</p>
        ...
        <div className="api-box">
          ...
          <div className="tree-view">
            {[
              ...
              { name: "collateralSwitch", type: "string", req: true, desc: "Whether to use as collateral", values: ["ON", "OFF"] },
            ].map(p => (
              <div className="tree-item" key={p.name}>
                <span className="p-name">{p.name}</span>
                <span className="p-type">{p.type}</span>
