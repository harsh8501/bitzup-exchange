    ...
    <div className="api-doc-container">
      ...
      <div className="docs-panel" ref={contentRef}>
        <div className="breadcrumb">
          <span>Market</span> <IoIosArrowForward size={12} /> <span className="pill">Get Orderbook</span>
        </div>
        <h1 className="api-title">Get Orderbook</h1>
        <p style={{ color: "#888", marginBottom: "40px" }}>Query the real-time order book (L2 snapshots) for a specific symbol.</p>
