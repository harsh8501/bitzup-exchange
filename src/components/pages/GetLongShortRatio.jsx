          ...
          <div className="row">
            ...
            <div className="col-lg-9 col-md-8 api-content" ref={contentRef}>
              ...
              <div className="breadcrumb mb-4">
                ...
                <span className="pill">Get Long Short Ratio</span>
              </div>

              {/* Title */}
              <h1 className="api-title">Get Long Short Ratio</h1>
              ...
              <div className="http-path">
                ...
                <span className="path">/v5/market/account-ratio</span>
              </div>
                ...
                <table className="table table-striped api-table mb-0">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>false</td>
                      <td>integer</td>
                      <td>Limit for data size per page. [1, 500]. Default: 50</td>
                    </tr>
                    <tr>
                      <td>cursor</td>
                      <td>false</td>
                ...
                <table className="table table-striped api-table mb-0">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>&gt; buyRatio</td>
                      <td>string</td>
                      <td>The ratio of users with net long positions</td>
                    </tr>
                    <tr>
                      <td>&gt; sellRatio</td>
                      <td>string</td>
                      <td>The ratio of users with net short positions</td>
                    </tr>
                    <tr>
                      <td>&gt; timestamp</td>
                      <td>string</td>
              ...
              <div>
                <Link to={"/docs/v5/market/long-short-ratio-api"} className="run-btn" style={{ marginBottom: "20px" }}>RUN &gt;&gt;</Link>
              </div>
