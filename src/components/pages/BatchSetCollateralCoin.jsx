...
export const BatchSetCollateralCoin = () => {
...
payload = {
    "request": [
        ...
        {"coin": "BTC", "collateralSwitch": "OFF"},
        {"coin": "ETH", "collateralSwitch": "OFF"},
        {"coin": "SOL", "collateralSwitch": "OFF"}
    ]
}
headers = {
    "Authorization": "Bearer <YOUR_API_KEY>",
          ...
          <div className="row">
            ...
            <div className="col-lg-9 col-md-8 api-content" ref={contentRef}>
              ...
              <div className="breadcrumb mb-4">
                ...
                <span className="pill">Batch Set Collateral Coin</span>
              </div>

              {/* Title */}
              <h1 className="api-title">Batch Set Collateral Coin</h1>
              ...
              <div className="http-path">
                ...
                <span className="path">/v5/account/set-collateral-switch-batch</span>
              </div>
