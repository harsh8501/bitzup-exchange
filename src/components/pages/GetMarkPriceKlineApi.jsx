    ...
    <div className="api-doc-container">
      ...
      <div className="docs-panel" ref={contentRef}>
        <div className="breadcrumb">
          <span>Market</span> <IoIosArrowForward size={12} /> <span className="pill">Get Mark Price Kline</span>
        </div>
        <h1 className="api-title">Get Mark Price Kline</h1>
        <p style={{ color: "#888", marginBottom: "40px" }}>Query historical mark price candlestick data for a specific symbol and interval.</p>
