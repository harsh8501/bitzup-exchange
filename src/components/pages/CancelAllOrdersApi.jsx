    ...
    <div className="api-doc-container">
      ...
      <div className="docs-panel" ref={contentRef}>
        <div className="breadcrumb">
          <span>Trade</span> <IoIosArrowForward size={12} /> <span className="pill">Cancel All Orders</span>
        </div>
        <h1 className="api-title">Cancel All Orders</h1>
        <p style={{ color: "#888", marginBottom: "40px" }}>Cancel all orders in the specified category.</p>
