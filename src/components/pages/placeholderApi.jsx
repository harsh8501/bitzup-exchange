    ...
    <div className="api-doc-container">
      ...
      <div className="docs-panel" ref={contentRef}>
        <div className="breadcrumb">
          <span>Trade</span> <IoIosArrowForward size={12} /> <span className="pill">Place Order</span>
        </div>
        ...
        <div className="api-box">
          ...
          <div className="tree-view">
            {[
              ...
              { name: "qty", type: "string", req: true, desc: "Order quantity" },
              { name: "price", type: "string", desc: "Order price" },
              { name: "timeInForce", type: "string", desc: "Time in force", values: ["GTC", "IOC", "FOK", "PostOnly"] },
