...
export const GetSpotQuotedPriceApi = () => {
    ...
    <div className="api-doc-container">
      ...
      <div className="docs-panel" ref={contentRef}>
        <div className="breadcrumb">
          <span>Convert</span> <IoIosArrowForward size={12} /> <span className="pill">Get Quoted Price</span>
        </div>
        <h1 className="api-title">Get Quoted Price</h1>
        <p style={{ color: "#888", marginBottom: "40px" }}>Get Quoted Price for cryptocurrency conversion.</p>

        <div className="api-box">
          <div className="api-box-header">Query Parameters</div>
          <div className="tree-view">
            {[
              { name: "fromCoin", type: "string", req: true, desc: "Quote currency e.g. USDT" },
              { name: "fromCoinSize", type: "string", req: false, desc: "Number of quote coins. Only one of fromCoinSize and toCoinSize is allowed" },
              { name: "toCoin", type: "string", req: true, desc: "Target currency e.g. ETH" },
              { name: "toCoinSize", type: "string", req: false, desc: "Number of target coins. Only one of fromCoinSize and toCoinSize is allowed" },
            ].map(p => (
        ...
        <RequestQueryEditor requestBody={requestBody} setRequestBody={setRequestBody} requiredFields={["fromCoin", "toCoin"]} />
      ...
      <ApiExplorer
        requiredFields={["fromCoin", "toCoin"]} 
        method="GET" 
...
export default GetSpotQuotedPriceApi;
