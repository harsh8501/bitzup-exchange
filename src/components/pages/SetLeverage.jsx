...
export const SetLeverage = () => {
  ...
  "message": "New leverage set successfully."
    ...
    const codeMap = {
        HTTP: `POST /futures/api/v1/set-leverage HTTP/1.1
Host: api.bitzup.com
                    ...
                    <div className="row">
                        <div className="col-lg-9 col-md-12 api-content" ref={contentRef}>
                            <div className="breadcrumb mb-4">
                                ...
                                <span className="pill">Set Leverage</span>
                            </div>

                            <h1 className="api-title">Set Leverage</h1>
                            <p className="api-desc">
                                Set the leverage for a specific symbol. In cross margin mode, buy and sell leverage
                                are set to the same value. In isolated margin mode, they can differ.
                            </p>
                            ...
                            <div className="http-path">
                                ...
                                <span className="path">/v1/set-leverage</span>
                            </div>
