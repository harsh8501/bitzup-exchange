...
export const GetSpotOrderbookDepthApi = () => {
    ...
    <div className="api-doc-container">
      ...
      <div className="docs-panel" ref={contentRef}>
        <div className="breadcrumb">
          <span>Market</span> <IoIosArrowForward size={12} /> <span className="pill">Get OrderBook Depth</span>
        </div>
        <h1 className="api-title">Get OrderBook Depth</h1>
        <p style={{ color: "#888", marginBottom: "40px" }}>Get OrderBook Depth for a specified trading pair.</p>
...
export default GetSpotOrderbookDepthApi;
