...
export const GetIndexPriceKlineApi = () => {
    ...
    <div className="api-doc-container">
      ...
      <div className="docs-panel" ref={contentRef}>
        <div className="breadcrumb">
          <span>Market</span> <IoIosArrowForward size={12} /> <span className="pill">Get Index Price Kline</span>
        </div>
        <h1 className="api-title">Get Index Price Kline</h1>
        <p style={{ color: "#888", marginBottom: "40px" }}>Query historical index price candlestick data for a specific symbol and interval.</p>
        ...
        <div className="api-box">
          ...
          <div className="tree-view">
            {[
              ...
              { name: "end", type: "integer", desc: "End timestamp (ms)" },
              { name: "limit", type: "integer", desc: "Limit per page. Default 200, max 1000" },
            ].map(p => (
