          ...
          <div className="row">
            ...
            <div className="col-lg-9 col-md-8 api-content" ref={contentRef}>
              ...
              <div className="breadcrumb mb-4">
                ...
                <span className="pill">Create Sub UID</span>
              </div>

              {/* Title */}
              <h1 className="api-title">Create Sub UID</h1>
              ...
              <div className="http-path">
                ...
                <span className="path">/v5/user/create-sub-member</span>
              </div>
                ...
                <table className="table table-striped api-table mb-0">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>true</td>
                      <td>string</td>
                      <td>6-16 characters, must include both numbers and letters. Cannot be the same as existing/deleted usernames.</td>
                    </tr>
                    <tr>
                      <td>password</td>
                      <td>false</td>
                      <td>string</td>
                      <td>8-30 characters, must include numbers, upper and lowercase letters.</td>
                    </tr>
                    <tr>
                      <td>memberType</td>
                      <td>true</td>
                ...
                <table className="table table-striped api-table mb-0">
                  ...
                  <tbody>
                    <tr>
                      <td>uid</td>
                      <td>string</td>
                      <td>Sub account user ID</td>
                    </tr>
                    <tr>
                      <td>username</td>
                      <td>string</td>
                      <td>Sub account login username</td>
                    </tr>
                    <tr>
                      <td>memberType</td>
                      <td>integer</td>
