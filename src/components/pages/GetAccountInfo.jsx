          ...
          <div className="row">
            ...
            <div className="col-lg-9 col-md-8 api-content" ref={contentRef}>
              ...
              <div className="breadcrumb mb-4">
                ...
                <span className="pill">Get Account Info</span>
              </div>

              {/* Title */}
              <h1 className="api-title">Get Account Info</h1>
              ...
              <div className="http-path">
                ...
                <span className="path">/v5/account/info</span>
              </div>
                ...
                <table className="table table-striped api-table mb-0">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>boolean</td>
                      <td>Whether it is a master trader</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td>updatedTime</td>
                      <td>string</td>
                      <td>Account data updated time (ms)</td>
                    </tr>
                    <tr>
                      <td>timeWindow</td>
                      <td>integer</td>
                      <td>Disconnection Protect time window (seconds)</td>
                    </tr>
                    <tr>
                      <td>smpGroup</td>
                      <td>integer</td>
                    ...
                    <tr>
                      <td>dcpStatus</td>
                      <td>string</td>
                      <td>Disconnect protection status</td>
                    </tr>
                  </tbody>
                </table>
              </div>
