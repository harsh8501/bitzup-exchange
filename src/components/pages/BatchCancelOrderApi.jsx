    ...
    <div className="api-doc-container">
      ...
      <div className="docs-panel" ref={contentRef}>
        <div className="breadcrumb">
          <span>Trade</span> <IoIosArrowForward size={12} /> <span className="pill">Batch Cancel Order</span>
        </div>
        <h1 className="api-title">Batch Cancel Order</h1>
        <p style={{ color: "#888", marginBottom: "40px" }}>Batch cancel orders.</p>
