                    ...
                    <div className="row">
                        <div className="col-lg-9 col-md-12 api-content" ref={contentRef}>
                            <div className="breadcrumb mb-4">
                                ...
                                <span className="pill">Get Margin Mode</span>
                            </div>
                            ...
                            <div className="http-path">
                                ...
                                <span className="path">/v1/get-margin-mode</span>
                            </div>
                            ...
                            <div className="api-table-box">
                                <table className="table table-striped api-table mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr><td>data</td><td>string</td><td><span className="pill">REGULAR_MARGIN</span> or <span className="pill">ISOLATED_MARGIN</span></td></tr>
                                    </tbody>
                                </table>
                            </div>
