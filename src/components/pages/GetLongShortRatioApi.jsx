    ...
    <div className="api-doc-container">
      ...
      <div className="docs-panel" ref={contentRef}>
        <div className="breadcrumb">
          <span>Market</span> <IoIosArrowForward size={12} /> <span className="pill">Get Long Short Ratio</span>
        </div>
        <h1 className="api-title">Get Long Short Ratio</h1>
        <p style={{ color: "#888", marginBottom: "40px" }}>Query the long-short ratio data for a specific symbol.</p>
