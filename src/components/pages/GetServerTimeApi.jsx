    ...
    <div className="api-doc-container">
      ...
      <div className="docs-panel" ref={contentRef}>
        <div className="breadcrumb">
          <span>Market</span> <IoIosArrowForward size={12} /> <span className="pill">Get Server Time</span>
        </div>
        <h1 className="api-title">Get Bitzup Server Time</h1>
        <p style={{ color: "#888", marginBottom: "40px" }}>Retrieve the current server time for synchronization purposes.</p>
