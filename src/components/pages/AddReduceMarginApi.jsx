...
export const AddReduceMarginApi = () => {
    ...
    <div className="api-doc-container">
      ...
      <div className="docs-panel" ref={contentRef}>
        <div className="breadcrumb">
          <span>Position</span> <IoIosArrowForward size={12} /> <span className="pill">Add Or Reduce Margin</span>
        </div>
        <h1 className="api-title">Add Or Reduce Margin</h1>
        <p style={{ color: "#888", marginBottom: "40px" }}>Manually add or reduce margin for isolated margin positions.</p>
        ...
        <div className="api-box">
          ...
          <div className="tree-view">
            {[
              ...
              { name: "margin", type: "string", req: true, desc: "Margin adjustment. Positive to add, negative to reduce. E.g., '10' or '-10'" },
        ...
        <RequestQueryEditor requestBody={requestBody} setRequestBody={setRequestBody} requiredFields={["category", "symbol", "margin", "positionIdx"]} />
      ...
      <ApiExplorer
        requiredFields={["category", "symbol", "margin", "positionIdx"]} 
        method="POST" 
