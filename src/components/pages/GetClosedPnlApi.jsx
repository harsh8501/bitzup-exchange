    ...
    <div className="api-doc-container">
      ...
      <div className="docs-panel" ref={contentRef}>
        <div className="breadcrumb">
          <span>Position</span> <IoIosArrowForward size={12} /> <span className="pill">Get Closed PnL</span>
        </div>
        <h1 className="api-title">Get Closed PnL</h1>
        <p style={{ color: "#888", marginBottom: "40px" }}>Query your closed profit and loss history.</p>
