    ...
    return (
        <div className="container-fluid p-0"><div className="api-layout"><div className="row">
            <div className="col-lg-9 col-md-12 api-content" ref={contentRef}>
                <div className="breadcrumb mb-4"><span className="kline-market">User</span><span className="mx-2"><IoIosArrowForward className="kline-arrow" /></span><span className="pill">Freeze Sub UID</span></div>
                <h1 className="api-title">Freeze Sub UID</h1>
                <p className="api-desc">Freeze Sub UID. Use master user's api key only.</p>
                ...
                <div className="http-path"><span className="method post">POST</span><span className="path">/v5/user/frozen-sub-member</span></div>
                ...
                <div className="api-table-box"><table className="table table-striped api-table mb-0">
                    ...
                    <tbody>
                        <tr><td>subuid</td><td><strong>true</strong></td><td>integer</td><td>Sub user ID</td></tr>
                        <tr><td>frozen</td><td><strong>true</strong></td><td>integer</td><td><span className="pill">0</span>: unfreeze, <span className="pill">1</span>: freeze</td></tr>
                    </tbody>
                </table></div>
